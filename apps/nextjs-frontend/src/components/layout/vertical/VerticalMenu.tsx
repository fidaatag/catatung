...
type RenderExpandIconProps = {
  ...
  readonly transitionDuration?: VerticalMenuContextProps['transitionDuration'];
};
...
function VerticalMenu({scrollMenu}: {readonly scrollMenu: (container: any, isPerfectScrollbar: boolean) => void}) {
  // Hooks
