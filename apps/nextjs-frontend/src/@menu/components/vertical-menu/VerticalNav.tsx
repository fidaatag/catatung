...
export type VerticalNavProps = HTMLAttributes<HTMLHtmlElement> & {
  readonly width?: VerticalNavState['width'];
  readonly breakpoint?: BreakpointType;
  readonly customBreakpoint?: string;
  readonly breakpoints?: Partial<typeof defaultBreakpoints>;
  readonly transitionDuration?: VerticalNavState['transitionDuration'];
  readonly backdropColor?: string;
  readonly customStyles?: CSSObject;
};

function VerticalNav(props: VerticalNavProps) {
  // Props
  const {
    width = 260,
    breakpoint = 'lg',
